...
SWEP.Description = [[Full-auto assault rifle. High damage at close range with a slower fire rate. Fast bullet velocity and reliable recoil control with less ammo capacity.

The C58 is an assault rifle featured in Call of Duty: Black Ops Cold War. It was added as part of the Season Four update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_c58_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_c58_bocw.mdl"
...
SWEP.RangeMin = 30.48 * 39.37 -- How far bullets retain their maximum damage for.
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_c58_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "ARC9_BOCW.C58_fire"                            -- Fire
--SWEP.ShootSoundIndoor = "ARC9_BOCW.C58_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.C58_fire_silenced"                    -- Fire silenced
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_c58"},
}
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["c58_mag_ext"] then
        return anim .. "_ext"
    end

    if elements["c58_mag_dual"] then
        return anim .. "_dual"
    end

    if elements["c58_mag_mix"] then
        return anim .. "_mix"
    end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = {"ready"},
        EventTable = {
            { s = "ARC9_BOCW.C58_ready_boltback", t = 0 },
            { s = "ARC9_BOCW.C58_ready_boltrelease", t = 0.8 },
            { s = "ARC9_BOCW.C58_reload_end", t = 1.3 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["1_ready"] = {
        Source = {"ready_quick"},
        EventTable = {
            { s = "ARC9_BOCW.C58_ready_boltrelease", t = 0.4 },
            { s = "ARC9_BOCW.C58_reload_end", t = 0.7 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.C58_reload_maggrab", t = 0.9 },
    ...
    ["reload_empty_ext"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.C58_reload_start", t = 0 },
            { s = "ARC9_BOCW.C58_reload_boltback", t = 0.3 },
            { s = "ARC9_BOCW.C58_reload_magout", t = 1.15 },
            { s = "ARC9_BOCW.C58_reload_maggrab", t = 1.6 },
            { s = "ARC9_BOCW.C58_reload_magin", t = 2.1 },
            { s = "ARC9_BOCW.C58_reload_boltrelease", t = 3.2 },
    ...
    ["reload_dual"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.C58_reload_end", t = 2.1 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty_mix"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.C58_reload_start", t = 0 },
            { s = "ARC9_BOCW.C58_reload_boltback", t = 0.28 },
            { s = "ARC9_BOCW.C58_reload_magout", t = 1.1 },
            { s = "ARC9_BOCW.C58_reload_maggrab", t = 1.6 },
            { s = "ARC9_BOCW.C58_reload_magin", t = 2.1 },
            { s = "ARC9_BOCW.C58_reload_boltrelease", t = 3.2 },
            { s = "ARC9_BOCW.C58_reload_end", t = 3.8 },
    ...
    ["enter_inspect"] = {
        Source = "inspect",
        EventTable = {
            { s = "ARC9_BOCW.C58_inspect_part1", t = 0 },
            { s = "ARC9_BOCW.C58_inspect_part2", t = 3.3 },
            { s = "ARC9_BOCW.C58_inspect_part3", t = 5.1 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["1_enter_inspect"] = {
        Source = "inspect_fire",
        EventTable = {
            { s = "ARC9_BOCW.C58_inspect_fire_part1", t = 0 },
            { s = "ARC9_BOCW.C58_inspect_fire_part2", t = 3 },
        },
        IKTimeLine = {
            {
                t = 0,
