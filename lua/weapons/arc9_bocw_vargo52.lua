...
SWEP.Description = [[Full-auto assault rifle. Good damage at mid-range with a fast fire rate. Improved muzzle velocity and reliable handling for steady firing control.

The Vargo 52 is an assault rifle featured in Call of Duty: Black Ops Cold War and Call of Duty: Vanguard.

The Vargo 52 was added to Call of Duty: Black Ops Cold War on the March 4th, 2022 update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_vargo52_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_vargo52_bocw.mdl"
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_vargo52_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "ARC9_BOCW.Vargo52_fire"                            -- Fire
--SWEP.ShootSoundIndoor = "ARC9_BOCW.Vargo52_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.Vargo52_fire_silenced"                    -- Fire silenced
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Category = {"bocw_vargo52_muzzle", "bocw_east_muzzle_545"},
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_vargo52"},
}
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["vargo52_mag_ext"] then
        return anim .. "_ext"
    end

    if elements["vargo52_mag_dual"] then
        return anim .. "_dual"
    end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = {"ready"},
        EventTable = {
            { s = "ARC9_BOCW.Vargo52_boltback", t = 0.3 },
            { s = "ARC9_BOCW.Vargo52_boltrelease", t = 0.5 },
            { s = "ARC9_BOCW.Vargo52_reload_end", t = 0.8 },
        },
        IKTimeLine = {
            {
                t = 0,
