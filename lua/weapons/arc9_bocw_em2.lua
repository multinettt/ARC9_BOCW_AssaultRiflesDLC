...
SWEP.Trivia = {
     ...
     Calibre = ".280 British",
     Mechanism = "Gas-operated, flapper-locked",
...
SWEP.Description = [[Full-auto assault rifle. Well rounded British rifle with good firing control. Built in low-zoom optic improves accuracy. Slower fire rate with reliable range.

The EM2 was added to Call of Duty: Black Ops Cold War as part of the Season Five update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_em2_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_em2_bocw.mdl"
...
SWEP.Distance = 700 * 39.37 -- In Hammer units, how far bullets can travel, period.
...
SWEP.PhysBulletMuzzleVelocity = 771 * 39.37
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_em2_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "ARC9_BOCW.EM2_fire"                            -- Fire
--SWEP.ShootSoundIndoor = "ARC9_BOCW.EM2_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.EM2_fire_silenced"                    -- Fire silenced
...
SWEP.Attachments = {
    ...
    },
    {
        Hidden = true,
        Bone = "tag_weapon",
        Pos = Vector(-0.04, 0, 4.56),
        Ang = Angle(0, 0, 0),
        Category = {"optic_em2"},
        Installed = "bocw_optic_em2",
        MergeSlots = {1,2}
    },
    {
        PrintName = "MUZZLE",
        ...
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_em2_muzzle"},
        Installed = "bocw_em2_muzzle_base",
    },
    {
        PrintName = "BARREL",
        Bone = "tag_barrel",
        ...
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_em2_barrel"},
    },
    {
        PrintName = "BODY",
        Bone = "tag_weapon",
        Pos = Vector(14, 0.6, 3.25),
        Ang = Angle(0, 0, -90),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_em2_body"},
    },
    {
        PrintName = "UNDRBARREL",
        Bone = "tag_weapon",
        Pos = Vector(-11.5, -4.42, 5.5),
        Ang = Angle(0, 0, 0),
    ...
    },
    {
        ...
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_em2_reloadsound"},
        CosmeticOnly = true,
    },
    {
        PrintName = "TRIG GUARD",
        Bone = "tag_weapon",
        Pos = Vector(0, 0, 0),
        Ang = Angle(0, 0, 0),
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_em2"},
}
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["em2_mag_dual"] then
        if elements["em2_sound_reload"] then
            return anim .. "_dual_old"
        else
            return anim .. "_dual"
        end
    end

    if elements["em2_mag_mix"] then
        if elements["em2_sound_reload"] then
            return anim .. "_mix_old"
        else
            return anim .. "_mix"
        end
    end
...
SWEP.Animations = {
    ...
    ["1_enter_inspect"] = {
        Source = "inspect_fire",
        EventTable = {
            { s = "ARC9_BOCW.EM2_inspect_fire_part1", t = 0 },
            { s = "ARC9_BOCW.EM2_inspect_fire_part2", t = 3 },
        },
        IKTimeLine = {
            {
                t = 0,
