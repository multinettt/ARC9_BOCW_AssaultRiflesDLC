...
SWEP.ViewModel = "models/weapons/arc9/c_arc9_groza_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_groza_bocw.mdl"
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_groza_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "ARC9_BOCW.Groza_fire"                            -- Fire
--SWEP.ShootSoundIndoor = "ARC9_BOCW.Groza_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.Groza_fire_silenced"                    -- Fire silenced
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["groza_mag_ext"] then
        return anim .. "_ext"
    end

    if elements["groza_mag_dual"] then
        return anim .. "_dual"
    end

    if elements["groza_mag_mix"] then
        return anim .. "_mix"
    end
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.Groza_reload_end", t = 2.6 },
            { hide = 1, t = 0.75 },
            { hide = 0, t = 0.9 }
        },
        IKTimeLine = {
    ...
    ["reload_ext"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.Groza_reload_ext_magin", t = 1.2 },
            { s = "ARC9_BOCW.Groza_reload_end", t = 2 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty_ext"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.Groza_reload_start", t = 0 },
            { s = "ARC9_BOCW.Groza_reload_ext_magout", t = 0.2 },
            { s = "ARC9_BOCW.Groza_reload_ext_magin", t = 1.1 },
            { s = "ARC9_BOCW.Groza_boltback", t = 2 },
            { s = "ARC9_BOCW.Groza_boltrelease", t = 2.25 },
            { s = "ARC9_BOCW.Groza_reload_end", t = 2.65 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_dual"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.Groza_reload_magin", t = 0.9 },
            { s = "ARC9_BOCW.Groza_reload_end", t = 1.5 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty_dual"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.Groza_reload_magout", t = 0.2 },
            { s = "ARC9_BOCW.Groza_reload_magin", t = 0.8 },
            { s = "ARC9_BOCW.Groza_boltback", t = 1.6 },
            { s = "ARC9_BOCW.Groza_boltrelease", t = 1.8 },
            { s = "ARC9_BOCW.Groza_reload_end", t = 2.3 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["1_reload_empty_dual"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.Groza_reload_magout", t = 0.2 },
            { s = "ARC9_BOCW.Groza_reload_magin", t = 1 },
            { s = "ARC9_BOCW.Groza_boltback", t = 1.8 },
            { s = "ARC9_BOCW.Groza_boltrelease", t = 2 },
    ...
    ["reload_mix"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.Groza_reload_start", t = 0 },
            { s = "ARC9_BOCW.Groza_reload_magout", t = 0.3 },
            { s = "ARC9_BOCW.Groza_reload_magin", t = 1.2 },
    ...
    ["reload_empty_mix"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.Groza_reload_start", t = 0 },
            { s = "ARC9_BOCW.Groza_reload_magout", t = 0.3 },
            { s = "ARC9_BOCW.Groza_reload_magin", t = 1.15 },
            { s = "ARC9_BOCW.Groza_boltback", t = 1.95 },
            { s = "ARC9_BOCW.Groza_boltrelease", t = 2.15 },
            { s = "ARC9_BOCW.Groza_reload_end", t = 2.6 },
            { hide = 1, t = 0.75 },
    ...
    ["enter_inspect"] = {
        ...
        Time = 5.2,
        EventTable = {
            { s = "ARC9_BOCW.Groza_inspect_part1", t = 0 },
            { s = "ARC9_BOCW.Groza_inspect_part2", t = 3.3 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["1_enter_inspect"] = {
        Source = "inspect_fire",
        EventTable = {
            { s = "ARC9_BOCW.Groza_inspect_fire_part1", t = 0 },
            { s = "ARC9_BOCW.Groza_inspect_fire_part2", t = 3 },
        },
        IKTimeLine = {
            {
                t = 0,
